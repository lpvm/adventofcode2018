Red [ 
	Title:  "Advent of Code 2018 - Day 04 - Part 02" 
	Date:   2018-12-10
	File:   %day04_part02.red
...
foreach [guard minute-profile] body-of guards-sleeping-profile [
	foreach [minute slept] body-of minute-profile [
		if slept > max-minutes-slept [
			max-minutes-slept: slept
...
print rejoin ["part 02: " guard-sleeps-most * minute-most-slept]
